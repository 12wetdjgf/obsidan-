...
很好！你已经安装了 IntelliJ IDEA，这是第一步。让我们先搞定工具，再用苏格拉底式的对话引导你完成作业。
...
> 苏格拉底问你：**"你如何判断一个人是不是 'Ergun'？在 Java 中，比较字符串和比较数字有什么不同？"**
...
> 苏格拉底问你：**"如果我给你一串数字，你怎么找到最大值和最小值？你会怎么一步步思考？"**
...
> 苏格拉底问你：**"如何把一个列表里所有数字加起来？你需要一个什么样的'容器'来积累总和？"**
...
> 苏格拉底问你：**"怎么判断一个数是偶数？你需要返回一个新的列表，如何创建它？"**
...
> 苏格拉底问你：**"如何知道某个元素在另一个列表里存在？List 有什么方法可以帮你？"**
...
> 苏格拉底问你：**"如何遍历一个字符串里的每一个字符？String 有什么方法？"**
...
> 苏格拉底问你：**"'a' 对应 1，'b' 对应 2... 如果我告诉你字符可以做加减法运算，你能算出每个字母对应的数字吗？"**
...
> 苏格拉底问你：**"Map 的 put 方法需要什么参数？key 和 value 分别是什么？"**
...
> 苏格拉底问你：**"如果一个单词已经在 map 里了，你应该怎么更新它的计数？如果还没有呢？"**
...
> 苏格拉底问你：**"实例变量和静态变量有什么区别？如果我说 '静态变量被所有对象共享'，这对 numDesserts 意味着什么？"**
...
- [ ] 在 IntelliJ 中打开 hw0b 项目
- [ ] 尝试运行已有的测试，看看初始状态
- [ ] 完成 `JavaExercises.java` 的4个方法
- [ ] 完成 `ListExercises.java` 的4个方法  
- [ ] 完成 `MapExercises.java` 的3个方法
- [ ] 创建 `Dessert.java` 并实现所有要求
- [ ] 运行所有测试，确保通过

---

**遇到具体问题时，随时告诉我！** 我会继续用苏格拉底的方式引导你思考，而不是直接给你答案。加油！💪